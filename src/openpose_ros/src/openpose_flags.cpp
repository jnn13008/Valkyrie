...
// OpenPose
DEFINE_string(model_folder,             "/homessd/nvidia/openpose/models/",      "Folder path (absolute or relative) where the models (pose, face, ...) are located.");
...
DEFINE_string(model_pose,               "COCO",      "Model to be used. E.g., `BODY_25` (fastest for CUDA version, most accurate, and includes"
